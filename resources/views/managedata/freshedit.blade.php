            ...
            <div class="card card-primary card-outline">
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <input name="alternate_no" type="tel" class="form-control"
                                            value="{{ $data->alternate_no }}" id="alternate_no">
                                    </div>
                                    <div class="col-md-6">
                                        <input name="alternate_no" type="tel" class="form-control"
                                            value="{{ $data->alternate_no }}" id="alternate_no">
                                        <small id="alternate_no_error" class="text-danger"></small>
                                    </div>
                                </div>
                            </div>
                        </div> --}}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tel">Alternate Number</label>
                                <input name="alternate_no" type="tel" class="form-control"
                                    value="{{ $data->alternate_no }}" id="alternate_no">
                                <small id="alternate_no_error" class="text-danger"></small>
                            </div>
        ...
        <div class="col-md-6">
            <div class="card card-primary card-outline">
                <div class="card-body">
                    ...
                    <br>
                    <div class="form-group">
                        <label for="tel">Customer Calling Number</label>
                        <input name="calling_no" type="tel" class="form-control" id="calling_no">
                        <small id="calling_no_error" class="text-danger"></small>
                    </div>
                    <div class="form-group">
    ...
    $(function() {
        ...
        $('#connect_status').on('change', function() {
            ...
            if (selectedConnectStatus == 'Call Back') {
                $('#callbackDiv').show();
                $('#followupDiv').hide();
            } else if (selectedConnectStatus == 'Switch off' || selectedConnectStatus ==
                'Invalid number' || selectedConnectStatus == 'Not Reachable' ||
                selectedConnectStatus == 'Ringing' || selectedConnectStatus == 'Incoming barred' ||
                selectedConnectStatus == 'Number busy') {
                $('#quotation_div').hide();
                $('#price_div').hide();
                $('#callbackDiv').hide();
                $('#followupDiv').hide();
            ...
            } else if (selectedConnectStatus == 'Customer Disconnected the call' ||
                selectedConnectStatus == 'Due Later' ) {
                if (selectedConnectStatus) {
                    $('#callbackDiv').hide();
                    $('#followupDiv').show();
                } else {
...
<script>
    var callingNoInput = document.getElementById('calling_no');
    var callingNoError = document.getElementById('calling_no_error');
    callingNoInput.addEventListener('input', function() {
        var callingNoValue = callingNoInput.value.trim();
        // Validate the phone number (check for 10 digits)
        if (/^\d{10}$/.test(callingNoValue)) {
            callingNoError.textContent = '';
        } else {
            callingNoError.textContent = 'Calling number should be 10 digits.';
        }
    });
</script>

<script>
    var alternateNoInput = document.getElementById('alternate_no');
    var alternateNoError = document.getElementById('alternate_no_error');
    alternateNoInput.addEventListener('input', function() {
        var alternateNoValue = alternateNoInput.value.trim();
        // Validate the phone number (check for 10 digits)
        if (/^\d{10}$/.test(alternateNoValue)) {
            alternateNoError.textContent = '';
        } else {
            alternateNoError.textContent = 'Phone number should be 10 digits.';
        }
    });
</script>
...
<script>
    function call() {
        var calling_no = document.getElementById('calling_no').value.trim();
        if (/^\d{10}$/.test(calling_no)) {
            ...
            toastr.error('Please enter a valid 10-digit calling number.');
        }
    };
</script>
